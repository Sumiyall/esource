...
import 'tech_task_list.dart';
import '../../../provider/task_provider.dart';
import 'package:provider/provider.dart';

class AddTechWorkPage extends StatefulWidget {
  @override
  _AddTechWorkPageState createState() => _AddTechWorkPageState();
}

class _AddTechWorkPageState extends State<AddTechWorkPage> {
...
List<dynamic> _dropdownData = [];
  ...
  if (_formKey.currentState!.validate() &&
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => TechTaskListPage()),
    );
  } else {
