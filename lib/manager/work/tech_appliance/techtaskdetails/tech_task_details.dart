...
class TechTaskDetailsPage extends StatefulWidget {
  final Map<String, String> task;
  final Function(Map<String, String>) onSave;
  final Function() onDelete;

  const TechTaskDetailsPage({
    Key? key,
    required this.task,
  ...
  @override
  _TechTaskDetailsPageState createState() => _TechTaskDetailsPageState();
}

class _TechTaskDetailsPageState extends State<TechTaskDetailsPage> {
